 ...
 *
 * v0.2 additions:
 *   - Converted from static module to dynamic DLL (RoseOnLoad, DllMain)
 *   - Linked against stub-rpc.c for build-time RpcChannel_Send resolution
 *   - Fixed SetGuestInfo RPC reply handling
 *
 * TODO v0.3:
...
/* GuestInfoType values - mirrors guestInfo.h enum (zero is unused) */
#define INFO_DNS_NAME               1
#define INFO_IPADDRESS              2
#define INFO_DISK_FREE_SPACE        3
#define INFO_BUILD_NUMBER           4
#define INFO_OS_NAME_FULL           5
#define INFO_OS_NAME                6
#define INFO_UPTIME                 7
...
GuestInfoGather(RoseAppCtx *ctx)
{
   ...
   /* TODO v0.3: disk info */
   /* TODO v0.3: memory/stats */
   /* TODO v0.3: uptime */
   /* TODO v0.3: full XDR NIC info */
}
...
GuestInfoServerShutdown(void *src, void *data)
{
   ...
   (void)data;
   GuestInfoClearCache();
   /* TODO v0.3: GuestInfo_StatProviderShutdown equivalent */
   /* TODO v0.3: NetUtil_FreeIpHlpApiDll equivalent */
}
...
{
   /*
    * TODO v0.3: send uptime when capabilities are set.
