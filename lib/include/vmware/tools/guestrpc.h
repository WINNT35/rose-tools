...
/* ROSE-TOOLS BEGIN: replaced glib.h + utils.h with stddef.h + rose type shims.
 * glib.h is not available in our MinGW build. G_BEGIN_DECLS/G_END_DECLS
 * replaced with standard extern "C" guards. gboolean/gchar/gpointer/guint
 * replaced with C89 equivalents. GMainContext forward declared as opaque. */
/* ROSE-TOOLS ORIGINAL:
#ifdef __cplusplus
extern "C++" {
#endif
...
/* Forward declare GMainContext as opaque - only used in RpcChannel_Setup
 * which is guarded by USE_RPCI_ONLY and not called in our build. */
...
/* ROSE-TOOLS BEGIN: replaced G_END_DECLS with standard extern "C" close */
/* ROSE-TOOLS ORIGINAL:
G_END_DECLS
*/
#ifdef __cplusplus
